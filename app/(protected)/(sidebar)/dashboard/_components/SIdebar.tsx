...
export default function Sidebar() {
  return (
    <div className="hidden md:block w-72 h-full border-r-2 fixed top-0 left-0 p-8 py-3 pt-20 text-davy bg-coolWhite z-40 overflow-x-hidden scrollbar-none space-y-0">
      <Link
        href={"/dashboard"}
